...
import { StickyMobileSummary } from "@/components/checkout/StickyMobileSummary";
...
export default function OnePageStickyCheckout() {
  // VariantId only accepts "one-page" | "hybrid". Keep "one-page" so events
  // still aggregate against variant A in the analytics dashboard.
  ...
  return (
    <div className="min-h-screen">
      <StickyMobileSummary cart={summaryCart} offer={offer} />
